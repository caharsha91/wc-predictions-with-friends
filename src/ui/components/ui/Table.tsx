    ...
    >
      <table
        ...
        className={cn(
          ...
          '[&_th]:border-b [&_th]:border-border/50 [&_th]:bg-bg2/30 [&_th]:px-3 [&_th]:py-2.5 [&_th]:text-[length:var(--text-xs)] [&_th]:uppercase [&_th]:tracking-[0.12em] [&_th]:text-muted-foreground',
